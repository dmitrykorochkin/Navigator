...
// Проверяем наличие данных в $_POST перед отправкой письма
if (isset($_POST['name']) && isset($_POST['phone'])) {
    ...
    $result = "error";
    $status = "Переменные 'name' и/или 'phone' не найдены";
}

// Инициализируем переменную $status, если она не была определена
if (!isset($status)) {
    $status = "";
}
